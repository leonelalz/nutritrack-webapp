 ...
 * Planes y rutinas que el usuario ha activado
 */
@Component({
...
export class MisAsignacionesComponent implements OnInit {
  ...
  cargarAsignaciones(): void {
    ...
    Promise.all([
      this.catalogoService.obtenerPlanesActivos().toPromise(),
      this.catalogoService.obtenerRutinasActivas().toPromise()
    ])
  ...
  pausarPlan(planId: number): void {
    this.catalogoService.pausarPlan(planId).subscribe({
      next: () => {
  ...
  reanudarPlan(planId: number): void {
    this.catalogoService.reanudarPlan(planId).subscribe({
      next: () => {
  ...
  completarPlan(planId: number): void {
    this.catalogoService.completarPlan(planId).subscribe({
      next: () => {
  ...
  cancelarPlan(planId: number): void {
    this.catalogoService.cancelarPlan(planId).subscribe({
      next: () => {
  ...
  pausarRutina(rutinaId: number): void {
    this.catalogoService.pausarRutina(rutinaId).subscribe({
      next: () => {
  ...
  reanudarRutina(rutinaId: number): void {
    this.catalogoService.reanudarRutina(rutinaId).subscribe({
      next: () => {
  ...
  completarRutina(rutinaId: number): void {
    this.catalogoService.completarRutina(rutinaId).subscribe({
      next: () => {
  ...
  cancelarRutina(rutinaId: number): void {
    this.catalogoService.cancelarRutina(rutinaId).subscribe({
      next: () => {
